                    ...
                    <div key={index} className='experience-item flex flex-col items-start justify-between md:flex-row'>
                        ...
                        <div className='w-full md:w-3/4'>
                           <h3 className='mb-2 text-lg lg:text-2xl'>
                                ...
                                <p className='mb-4 text-sm lg:text-base font-thin'>{exp.description}</p>
                                <div className='flex flex-wrap gap-2'>
                                    {exp.techStack.map((tech, id) => (
                                        <span key={id} className='rounded-full border-2 border-pink500/30 px-3 py-1 text-sm font-semibold'>
                                            {tech}
                                        </span>
                                    ))}
                                </div>
